...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The right pane content updates based on the currently active slot
- [ ] #2 Quick presets and library/provider suggestions are presented together as helper content for the active slot
- [ ] #3 Users can insert helper content into the active slot without leaving the current editing context
- [ ] #4 The helper surface no longer depends on a detached top-of-form preset panel pattern
<!-- AC:END -->
