...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 txt2img prefill endpoint returns compatible prompt/settings payload
- [ ] #2 img2img and img2vid use the gallery asset as source image
- [ ] #3 Clients only receive compatible actions per asset type and origin
<!-- AC:END -->
