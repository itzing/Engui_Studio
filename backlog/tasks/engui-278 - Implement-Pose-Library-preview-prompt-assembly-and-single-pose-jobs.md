...
- [ ] Preview prompt assembly uses global preview settings, neutral studio/style preset, pose prompt, orientation, framing, camera angle, and shot distance.
- [ ] No manual one-off override prompt is available.
- [ ] Pose detail can request 1/2/4/8 variants with default 4.
- [ ] Preview jobs appear in the common Jobs pipeline/panel.
- [ ] Successful preview outputs are materialized as preview candidates linked to the pose.
