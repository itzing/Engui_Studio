...
export const MODELS: ModelConfig[] = [
    ...
    },
    {
        ...
        parameters: [
            ...
            { name: 'seed', label: 'Seed', type: 'number', default: 42, group: 'advanced' },
            { name: 'cfg', label: 'CFG Scale', type: 'number', default: 1.0, min: 1, max: 20, step: 0.1, group: 'hidden' },
            { name: 'steps', label: 'Steps', type: 'number', default: 6, min: 4, max: 12, group: 'advanced' },
            { name: 'sigma_shift', label: 'Sigma shift', type: 'number', default: 8, min: 3, max: 8, step: 1, group: 'advanced', control: 'slider' },
            { name: 'fps', label: 'FPS', type: 'select', options: ['16', '32'], default: '32', group: 'advanced', control: 'segmented' },
    ...
    // --- Image Models ---
    {
        ...
        parameters: [
            ...
            // { name: 'loraWeight', label: 'LoRA Weight', type: 'number', default: 1.0, min: -10.0, max: 10.0, step: 0.1, group: 'advanced' }
        ]
    },
    {
        id: 'qwen-image-edit',
